...
public class Kelas_Controller {
    ...
    public Kelas_Controller(Kelas_View view) throws ClassNotFoundException{
    ...
    public void kelas(){
        ...
        model.setProgramkls(view.getTxtProgramkls().getText());
        model.setHari(view.getTxtHari().getText());
