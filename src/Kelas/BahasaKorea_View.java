 ...
 * @author USER
 */
public class BahasaKorea_View extends javax.swing.JFrame {

    /**
     * Creates new form CobaHome_View
     */
    TabelKorea_Controller controller;
    public BahasaKorea_View() throws ClassNotFoundException {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        controller = new TabelKorea_Controller(this);
    }
    ...
    public JTable getTbBahasaKorea() {
        return tbBahasaKorea;
    }
    ...
    private void initComponents() {
        ...
        tbBahasaKorea.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                tbBahasaKoreaAncestorAdded(evt);
            }
    ...
    private void tbBahasaKoreaAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tbBahasaKoreaAncestorAdded
        // TODO add your handling code here:
         try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BahasaKorea_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BahasaKorea_View().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(BahasaKorea_View.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
